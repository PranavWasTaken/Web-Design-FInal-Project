    ...
    <MDBFooter style={{backgroundColor: "Black"}} className="font-small pt-4 mt-4">
        ...
        <MDBRow>
          ...
          <MDBCol md="2" className='ml-5'>
            <FontAwesomeIcon icon="phone-alt" color="white" /> &nbsp;
              <span>+1 857 693 9783</span><br></br>
          </MDBCol>
          <MDBCol md="3" className='ml-2'>
            ...
            <div>
              ...
              <a href="mailto:jain.shu@northeastern.edu, chudi.d@northeastern.edu, ananthula.sh@northeastern.edu" target = "gmail.com" >cinestream@gmail.com</a>
            </div>
          </MDBCol> 
      ...
      <div className="footer-copyright text-center py-2">
        <MDBContainer fluid style={{color: "white"}}>
          &copy; {new Date().getFullYear()} Copyright: <a href="#"> Cinestream.com </a>
        </MDBContainer>
      </div>
    </MDBFooter>
  );
